        ...
        <section class="featured" id="featured">
          ...
          <div class="swiper ">
            ...
            <div class="box">
                ...
                <div class="content">
                    <h3>featured book</h3>
                    <div class="price">₹800 <span>₹800</span></div>
                    <a href="/#" class="btn">add to cart</a>
                </div>
            </div>
            </SwiperSlide>
            ...
            <div className="swiper">
                ...
                <SwiperSlide>
                    <a href="\#" className='box'>
                        ...
                        <div className="content">
                            <h3>new arrivals</h3>
                            <div className="price">₹800 <span>₹800</span></div>
                            <div className="stars">
                                <i><FaStar /></i>
                                <i><FaStar /></i>
                                <i><FaStar /></i>
        ...
        <section className="footer">
            <div className="box-container">
                ...
                <div className="box">
                    ...
                    <a href="\#"><i><FaPhoneAlt /></i>+123-356-546</a>
                    <a href="\#"><i><FaEnvelope /></i>johncena@gmail.com</a>
            ...
            <div className="credit">created by <span>Aman Rawal</span></div>
        </section>
